...
class BookPage extends Component {
	render() {
		...
		return ( < div className = "book" > < div className = "book-top" > < div className = "book-cover"
			...
			disabled > Move to... < /option> < option value = "currentlyReading" > Currently Reading < /option> < option value = "wantToRead" > Want to Read < /option> < option value = "read" > Read < /option> < option value = "none" > None < /option> < /select> < /div> < /div> < div className = "book-title" > {
